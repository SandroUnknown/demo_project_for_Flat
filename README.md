...
> _<p align="justify"><a href="https://flat-soft.ru/"><img src="media/icons/logo.png" width="128" alt="FLAT-SOFT"/></a></p>_
...
> | `REMOTE_URL`      | Адрес удалённого сервера, где будут запускаться тесты   | (пустое значение)     |
...
> </br>
>
> **Удаленный запуск через Jenkins (с параметрами)**
> ```
> clean
> -Dtask="${TASK}"
...
> 
> <img src="media/screenshots/scr1.png" width="100%" height="800">
> </br></br></br>
>
> **Ручные тесты !!!**
> 
...
> _со статистикой пройденных тестов_
> 
> | ![Alt name of image](/media/screenshots/scr1.png) |
> |-|
>
> </br>
>
