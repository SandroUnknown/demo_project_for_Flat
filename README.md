...
* Посмотреть лог
* Посмотреть [<img src="media/icons/Allure.svg" width="16" height="16" alt="Allure"/> &nbsp Allure Report](#allure)
* Посмотреть [<img src="media/icons/AllureTestOps.svg" width="16" height="16" alt="Allure TestOps"/> &nbsp Allure TestOps](#allure-testops)
