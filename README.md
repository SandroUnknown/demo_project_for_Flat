...
* Посмотреть лог
* Посмотреть <img src="media/icons/Allure.svg" width="16" height="16" alt="Allure"/> Allure Report
* Посмотреть <img src="media/icons/AllureTestOps.svg" width="16" height="16" alt="Allure TestOps"/> Allure TestOps
