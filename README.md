...
* Главная страница (ссылка)
  ...
  - [x] Проверка наличия и корректности контактных данных в нижней части страницы (в futor) <sup>[содержит tag `Smoke` и `TopMenu`]</sup>;
  - [x] Проверка всех пунктов (и подпунктов) главного меню на предмет корректности ссылок и наименования <sup>[содержит tag `Smoke` и `TopMenu`]</sup>;
* Текст 2
