...
| `main_page_content_only`    | Запускает тесты, проверяющие **только контент главной страницы** (без проверки общих для сайта элементов, таких как меню, footer и topbar)   |
| `partner_page`              | Запускает тесты, **полностью** проверяющие только **страницу партнеров**                                                                     |
| `partner_page_content_only` | Запускает тесты, проверяющие **только контент страницы партнеров** (без проверки общих для сайта элементов, таких как меню, footer и topbar) |
